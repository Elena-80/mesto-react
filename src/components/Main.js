    ...
    <main>
        <section className="profile">
            ...
            <div className = "profile__info">
                ...
                <button type="button" aria-label="Редактирование профиля пользователя" className="profile__edit-button" onClick={props.onEditProfile}></button>
                </div>
                <h2 className="profile__profession">{userDescription}</h2>
            </div>
            <button type="button" aria-label="Добавление новых фотографий" className="profile__add-button" onClick={props.onAddPlace}></button>
        </section>
